...
if [[ "$CHANNEL" =~ "em" ]]
then
    PROCESSES=data_obs,EMB,ZL,TTL,TTT,VVL,W,WH125,ZH125,ttH125,ggHWW125,qqHWW125,WHWW125,ZHWW125,ggH125,qqH125,QCD
else
    PROCESSES=data_obs,EMB,ZL,TTL,TTT,VVL,WH125,ZH125,ttH125,ggHWW125,qqHWW125,ggH125,qqH125,WHWW125,ZHWW125,FAKES
fi
# Produce shapes
