...
if [ -n "$TEST_RECALL_PRECISION" ]
then
    python htt-ml/testing/keras_recall_precision.py ml/${ERA}_${CHANNEL}_training_custom_loss.yaml ml/${ERA}_${CHANNEL}_testing.yaml 0
    python htt-ml/testing/keras_recall_precision.py ml/${ERA}_${CHANNEL}_training_custom_loss.yaml ml/${ERA}_${CHANNEL}_testing.yaml 1
fi
...
python htt-ml/testing/keras_confusion_matrix.py \
    ml/${ERA}_${CHANNEL}_training_custom_loss.yaml ml/${ERA}_${CHANNEL}_testing.yaml 1
fi
