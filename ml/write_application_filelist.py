...
def main(args):
    ...
    if args.channel == "mt":
        ...
        for estimation in [
                ...
                ZTTEstimation(era, args.directory, channel) if not args.emb else ZTTEmbeddedEstimation(era, args.directory, channel),
                ZLEstimationMTSM(era, args.directory, channel),
                ZJEstimationMT(era, args.directory, channel),
                TTTEstimationMT(era, args.directory, channel) if not args.emb else TTTNoTauTauEstimationMT(era, args.directory, channel),
    ...
    if args.channel == "et":
        ...
        for estimation in [
                ...
                TTTEstimationET(era, args.directory, channel) if not args.emb else TTTNoTauTauEstimationET(era, args.directory, channel),
    ...
    if args.channel == "tt":
        ...
        for estimation in [
                ...
                TTTEstimationTT(era, args.directory, channel) if not args.emb else TTTNoTauTauEstimationTT(era, args.directory, channel),
