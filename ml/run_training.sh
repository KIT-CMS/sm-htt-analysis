...
logandrun python htt-ml/training/keras_training.py $outdir/dataset_config.yaml 0 --balance-batches False
logandrun python htt-ml/training/keras_training.py $outdir/dataset_config.yaml 1 --balance-batches False
