...
if __name__ == "__main__":
    ...
    label_dict = {
        "r_ggH_0J" : "0 Jet",
        "r_ggH_1J_PTH_0_60" : "1 Jet p_{T}^{H} [0,60]",
        "r_ggH_1J_PTH_60_120" : "1 Jet p_{T}^{H} [60,120]",
        "r_ggH_1J_PTH_GT120" : "1 Jet p_{T}^{H} [120,#infty]",
        "r_qqH_PTJET1_GT200" : "p_{T}^{j1} > 200 GeV",
        "r_VBFTOPO" : "VBF Topology",
        "r_qqH_VH2JET" : "V(qq)H Topology",
        "r_ggH_GE2J" : "#geq 2 Jet",
        "r_qqH_REST" : "Rest",
    }
    label_list = [
        "r_ggH_0J",
    ...
    tex.SetTextSize(25)
    tex.SetTextFont(43)
    tex.DrawLatex(0.20, 0.955, "CMS")
    tex.DrawLatex(0.65, 0.955, "77.4 fb^{-1} (13 TeV)")
    tex.SetTextFont(53)
    tex.DrawLatex(0.30, 0.955, "Preliminary")
    for i in range(num_pois):
    ...
    texgrouplabel.DrawLatex(2.5,-1.3,"gg#rightarrowH,bbH")
    texgrouplabel.DrawLatex(7.0,-1.3,"VBF+V(qq)H")
    texgrouplabel.SetTextAngle(90)
    texgrouplabel.DrawLatex(-2.5,2.5,"gg#rightarrowH,bbH")
    texgrouplabel.DrawLatex(-2.5,7.0,"VBF+V(qq)H")
    ...
    c.SaveAs("{}_plot_poi_correlation.png".format(era))
