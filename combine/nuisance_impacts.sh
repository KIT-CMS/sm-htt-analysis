...
combineTool.py -M Impacts -m 125 -d ${ERA}_workspace.root --doFits --parallel 20 --robustFit 1 -t -1 --expectSignal=1 # --X-rtd FITTER_NEW_CROSSING_ALGO --X-rtd FITTER_NEVER_GIVE_UP # with this options it does not seem to find an end
