...
#python ${CMSSW_BASE}/src/CombineHarvester/HIG16006/scripts/plotMultiDimFit.py --title-right="35.9 fb^{-1} (13 TeV)" --cms-sub="Preliminary" --mass 125 -o 2D_limit_mH125 higgsCombine.Test.MultiDimFit.mH125.root
