...
def main(args):
    ...
    systematics_mm = Systematics("fitrecoil_mm_2017.root", num_threads=args.num_threads, find_unique_objects=True)
...
if __name__ == "__main__":
    ...
    setup_logging("produce_fitrecoil_2017.log", logging.INFO)
    main(args)
