...
def main(args):
    ...
    systematics_mm = Systematics("shapes_mm_recoilunc_2018.root", num_threads=args.num_threads, find_unique_objects=True)
...
if __name__ == "__main__":
    ...
    setup_logging("produce_shapes_recoilunc_2018.log", logging.INFO)
    main(args)
