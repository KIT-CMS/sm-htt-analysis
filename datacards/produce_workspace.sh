...
if [ $STXS_FIT == "stxs_stage1p1" ]; then
    combineTool.py -M T2W -o ${OUTPUT} -i ${INPUT} --parallel $NUM_THREADS \
        ...
        --PO '"map=^.*/qqH_QQ2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25:r_qqH_QQ2HQQ_GE2J_PTH_0_200[1,-70,70]"' \
        --PO '"map=^.*/qqH_QQ2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_GT25:r_qqH_QQ2HQQ_GE2J_PTH_0_200[1,-70,70]"' \
        --PO '"map=^.*/qqH_QQ2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25:r_qqH_QQ2HQQ_GE2J_PTH_0_200[1,-70,70]"' \
        --PO '"map=^.*/qqH_QQ2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_GT25:r_qqH_QQ2HQQ_GE2J_PTH_0_200[1,-70,70]"'
fi
