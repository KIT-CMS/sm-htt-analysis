...
from shape_producer.channel import MTSM2016 as MT
from shape_producer.channel import ETSM2016 as ET
from shape_producer.channel import TTSM2016 as TT
from shape_producer.channel import EMSM2016 as EM
...
def main(args):
    ...
    systematics_mt = Systematics("shapes_mt_2016.root", num_threads=args.num_threads, find_unique_objects=True)
    systematics_et = Systematics("shapes_et_2016.root", num_threads=args.num_threads, find_unique_objects=True)
    systematics_tt = Systematics("shapes_tt_2016.root", num_threads=args.num_threads, find_unique_objects=True)
    systematics_em = Systematics("shapes_em_2016.root", num_threads=args.num_threads, find_unique_objects=True)
    systematics_mm = Systematics("shapes_mm_2016.root", num_threads=args.num_threads, find_unique_objects=True)
