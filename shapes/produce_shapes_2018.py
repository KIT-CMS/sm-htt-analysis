...
def main(args):
    ...
    mt_processes["QCD"] = Process("QCD", QCDEstimation_SStoOS_MTETEM(era, directory, mt,
            ...
            mt_processes["data"], friend_directory=mt_friend_directory, extrapolation_factor=1.0))
    ...
    et_processes["QCD"] = Process("QCD", QCDEstimation_SStoOS_MTETEM(era, directory, et,
            ...
            et_processes["data"], friend_directory=et_friend_directory, extrapolation_factor=1.0))
            ...
            if binup == "inf":
                tau_id_variations.append(
                    ReplaceWeight("CMS_eff_t_{}-{}_Run2018".format(bindown, binup), "taubyIsoIdWeight",
                        Weight("(((pt_2 >= {bindown})*tauIDScaleFactorWeightUp_medium_DeepTau2017v2p1VSjet_2)+((pt_2 < {bindown})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(bindown=bindown), "taubyIsoIdWeight"), "Up"))
                tau_id_variations.append(
                    ReplaceWeight("CMS_eff_t_{}-{}_Run2018".format(bindown, binup), "taubyIsoIdWeight",
                        Weight("(((pt_2 >= {bindown})*tauIDScaleFactorWeightDown_medium_DeepTau2017v2p1VSjet_2)+((pt_2 < {bindown})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(bindown=bindown),"taubyIsoIdWeight"), "Down"))
            else:
                tau_id_variations.append(
                    ReplaceWeight("CMS_eff_t_{}-{}_Run2018".format(bindown, binup), "taubyIsoIdWeight",
                        Weight("(((pt_2 >= {bindown} && pt_2 <= {binup})*tauIDScaleFactorWeightUp_medium_DeepTau2017v2p1VSjet_2)+((pt_2 < {bindown} || pt_2 > {binup})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(bindown=bindown, binup=binup),"taubyIsoIdWeight"), "Up"))
                tau_id_variations.append(
                    ReplaceWeight("CMS_eff_t_{}-{}_Run2018".format(bindown, binup), "taubyIsoIdWeight",
                        Weight("(((pt_2 >= {bindown} && pt_2 <= {binup})*tauIDScaleFactorWeightDown_medium_DeepTau2017v2p1VSjet_2)+((pt_2 < {bindown} || pt_2 > {binup})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(bindown=bindown, binup=binup),"taubyIsoIdWeight"), "Down"))
    ...
    tau_es_3prong1pizero_variations = create_systematic_variations(
        "CMS_scale_t_3prong1pizero_Run2018", "tauEsThreeProngOnePiZero", DifferentPipeline)
    ...
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_Absolute_Run2018", "jecUncAbsoluteYear", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_BBEC1", "jecUncBBEC1", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_BBEC1_Run2018", "jecUncBBEC1Year", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_EC2", "jecUncEC2", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_EC2_Run2018", "jecUncEC2Year", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_HF", "jecUncHF", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_HF_Run2018", "jecUncHFYear", DifferentPipeline)
    jet_es_variations += create_systematic_variations(
    ...
    jet_es_variations += create_systematic_variations(
        ...
        DifferentPipeline)
    jet_es_variations += create_systematic_variations(
        "CMS_scale_j_RelativeSample_Run2018", "jecUncRelativeSampleYear",
        DifferentPipeline)
    # Include JER
    jet_es_variations += create_systematic_variations(
    ...
    ele_fake_es_1prong_variations = create_systematic_variations(
        "CMS_ZLShape_et_1prong_barrel_Run2018", "tauEleFakeEsOneProngBarrel",
        DifferentPipeline)
    ele_fake_es_1prong_variations += create_systematic_variations(
        "CMS_ZLShape_et_1prong_endcap_Run2018", "tauEleFakeEsOneProngEndcap",
        DifferentPipeline)
    ele_fake_es_1prong1pizero_variations = create_systematic_variations(
        "CMS_ZLShape_et_1prong1pizero_barrel_Run2018", "tauEleFakeEsOneProngPiZerosBarrel",
        DifferentPipeline)
    ele_fake_es_1prong1pizero_variations += create_systematic_variations(
        "CMS_ZLShape_et_1prong1pizero_endcap_Run2018", "tauEleFakeEsOneProngPiZerosEndcap",
        DifferentPipeline)
    ...
    for decaymode in [0, 1, 10, 11]:
        tau_id_variations.append(
                    ReplaceWeight("CMS_eff_emb_t_dm{dm}_Run2018".format(dm=decaymode), "taubyIsoIdWeight",
                        Weight("(((decayMode_1=={dm})*tauIDScaleFactorWeightUp_medium_DeepTau2017v2p1VSjet_1)+((decayMode_1!={dm})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_1)*((decayMode_2=={dm})*tauIDScaleFactorWeightUp_medium_DeepTau2017v2p1VSjet_2)+((decayMode_2!={dm})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(dm=decaymode), "taubyIsoIdWeight"), "Up"))
        tau_id_variations.append(
                    ReplaceWeight("CMS_eff_emb_t_dm{dm}_Run2018".format(dm=decaymode), "taubyIsoIdWeight",
                        Weight("(((decayMode_1=={dm})*tauIDScaleFactorWeightDown_medium_DeepTau2017v2p1VSjet_1)+((decayMode_1!={dm})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_1)*((decayMode_2=={dm})*tauIDScaleFactorWeightDown_medium_DeepTau2017v2p1VSjet_2)+((decayMode_2!={dm})*tauIDScaleFactorWeight_medium_DeepTau2017v2p1VSjet_2))".format(dm=decaymode), "taubyIsoIdWeight"), "Down"))
    ...
    tau_es_3prong1pizero_variations = create_systematic_variations(
        "CMS_scale_emb_t_3prong1pizero_Run2018", "tauEsThreeProngOnePiZero", DifferentPipeline)
    tau_es_1prong_variations = create_systematic_variations(
    ...
    qcd_variations.append(ReplaceWeight(
        "CMS_htt_qcd_2jet_rate_Run2018", "qcd_weight",
    ...
    qcd_variations.append(ReplaceWeight(
        ...
        "Down"))
    qcd_variations.append(ReplaceWeight(
        "CMS_htt_qcd_2jet_shape_Run2018", "qcd_weight",
